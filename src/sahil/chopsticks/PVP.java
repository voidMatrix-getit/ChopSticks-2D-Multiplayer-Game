...
//		}).start();
	...
	private synchronized void initialize() throws Exception{
		...
		pvp_frm.setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("Resources\\logo_F.png")));
		pvp_frm.setResizable(true);
...
//		pvp_frm.setUndecorated(true);
		...
		cp_r_fist.setIcon(new ImageIcon(getClass().getResource("Resources\\cp_r_fist.png")));
		...
		cp_r_five.setIcon(new ImageIcon(getClass().getResource("Resources\\cp_r_five.png")));
		...
		cp_r_four.setIcon(new ImageIcon(getClass().getResource("Resources\\cp_r_four.png")));
		...
		cp_r_three.setIcon(new ImageIcon(getClass().getResource("Resources\\cp_r_three.png")));
		...
		cp_r_two = new JLabel("");
		cp_r_two.setIcon(new ImageIcon(getClass().getResource("Resources\\cp_r_two.png")));
		...
		cp_r_one = new JLabel("");
		cp_r_one.setIcon(new ImageIcon(getClass().getResource("Resources\\cp_r_one.png")));
		cp_r_one.setHorizontalAlignment(SwingConstants.CENTER);
		cp_r_one.setBounds(105, 61, 130, 128);
		r_pnl.add(cp_r_one);
		
		cp_l_fist = new JLabel("");
		cp_l_fist.setIcon(new ImageIcon(getClass().getResource("Resources\\cp_l_fist.png")));
		...
		cp_l_five.setIcon(new ImageIcon(getClass().getResource("Resources\\cp_l_five.png")));
		...
		cp_l_four.setIcon(new ImageIcon(getClass().getResource("Resources\\cp_l_four.png")));
		...
		cp_l_three.setIcon(new ImageIcon(getClass().getResource("Resources\\cp_l_three.png")));
		...
		cp_l_two = new JLabel("");
		cp_l_two.setIcon(new ImageIcon(getClass().getResource("Resources\\cp_l_two.png")));
		...
		cp_l_one = new JLabel("");
		cp_l_one.setIcon(new ImageIcon(getClass().getResource("Resources\\cp_l_one.png")));
		...
		p_l_fist = new JLabel("");
		p_l_fist.setIcon(new ImageIcon(getClass().getResource("Resources\\p_l_fist.png")));
		...
		p_l_five = new JLabel("");
		p_l_five.setIcon(new ImageIcon(getClass().getResource("Resources\\p_l_five.png")));
		...
		p_l_four = new JLabel("");
		p_l_four.setIcon(new ImageIcon(getClass().getResource("Resources\\p_l_four.png")));
		...
		p_l_three.setIcon(new ImageIcon(getClass().getResource("Resources\\p_l_three.png")));
		...
		p_l_two = new JLabel("");
		p_l_two.setIcon(new ImageIcon(getClass().getResource("Resources\\p_l_two.png")));
		...
		p_l_one = new JLabel("");
		p_l_one.setIcon(new ImageIcon(getClass().getResource("Resources\\p_l_one.png")));
		p_l_one.setHorizontalAlignment(SwingConstants.CENTER);
		p_l_one.setBounds(299, 61, 130, 128);
		l_pnl.add(p_l_one);
		
		p_r_fist = new JLabel("");
		p_r_fist.setIcon(new ImageIcon(getClass().getResource("Resources\\p_r_fist.png")));
		...
		p_r_five = new JLabel("");
		p_r_five.setIcon(new ImageIcon(getClass().getResource("Resources\\p_r_five.png")));
		...
		p_r_four = new JLabel("");
		p_r_four.setIcon(new ImageIcon(getClass().getResource("Resources\\p_r_four.png")));
		...
		p_r_three.setIcon(new ImageIcon(getClass().getResource("Resources\\p_r_three.png")));
		...
		p_r_two = new JLabel("");
		p_r_two.setIcon(new ImageIcon(getClass().getResource("Resources\\p_r_two.png")));
		...
		p_r_one = new JLabel("");
		p_r_one.setIcon(new ImageIcon(getClass().getResource("Resources\\p_r_one.png")));
...
//		}
	...
	public synchronized void Gameloop() throws Exception {
		
		msg.setText(ois.readUTF());
		...
		p2_r_h.add(1);
			...
			while(running) {
				...
				p1_l_h = (Vector<Integer>)ois.readObject();
				p1_r_h = (Vector<Integer>)ois.readObject();
				p2_l_h = (Vector<Integer>)ois.readObject();
				p2_r_h = (Vector<Integer>)ois.readObject();
				
				repaint();
				
				turn = ois.readBoolean();
				...
				oos.writeObject(p1_l_h);
				oos.flush();
    			oos.writeObject(p1_r_h);
    			oos.flush();
    			oos.writeObject(p2_l_h);
    			oos.flush();
    			oos.writeObject(p2_r_h);
    			oos.flush();
			}		
		} 
